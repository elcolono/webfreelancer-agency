...
export const sendMail = async (title, text, callback) => {
  const options = {
    from: "Webfreelancer <andreas.siedler@gmail.com>",
    to: ["andreas.siedler@gmail.com"],
    subject: title,
    text: text,
    html: HTML_TEMPLATE(title, text),
  };
...
export const HTML_TEMPLATE = (title, text) => {
  return `
    <!doctype html>
    <html lang="en">
      <head>
